Changes
=================
Removed title, using message alone
Kept icons but moved color to the left section only
Removed audio for lighter-weight component
Basically, CP specific template

TODO
=================
Allow custom template and styling (send PR)
